...
│
├── 📁 data/
│   ├── InsuranceData_raw.csv          (Original dataset - 10,004 records)
│   ├── InsuranceData_clean.csv        (Cleaned dataset)
│   ├── data_dictionary.md             (Column descriptions)
│   └── data_quality_report.txt        (Quality metrics)
│
├── 📁 dashboard/
│   ├── Insurance_Dashboard.pbix       (Main Power BI file)
│   ├── data_model_documentation.md    (Data relationships, schema)
│   └── dax_measures.md               (All DAX formulas explained)
│
├── 📁 screenshots/
│   ├── 01_Executive_Summary.png       (Dashboard page 1)
│   ├── 02_Claims_Performance.png      (Dashboard page 2)
│   ├── 03_Financial_Analysis.png      (Dashboard page 3)
│   ├── 04_Customer_Demographics.png   (Dashboard page 4)
│   ├── 05_Drill_Through_Page.png      (Dashboard page 5)
│   └── 06_Filters_Slicers.png        (Interactive features)
│
├── 📁 documentation/
│   ├── Data_Cleaning_Process.md       (ETL documentation)
│   ├── EDA_Analysis.md                (Exploratory data analysis)
...
│   ├── Claims_Analysis_Report.pdf     (Detailed claims analysis)
│   ├── Financial_Performance.pdf      (Revenue & profitability)
│   └── Customer_Insights.pdf          (Demographics & behavior)
│
├── 📁 assets/
│   ├── project_banner.png             (README header image)
